...
{
    public class CommandWin32_old
    {
        
        public async static Task<string> Execute_1(string path, string command, string args)
        {
            try
            {
        ...
        public async static Task<int> ExecuteBatch_1(string batchPath, string arg)
        {
            try
            {
                string _error = null;
        ...
        public async static Task<string> ExecuteBatchWithResponse_1(string batchPath, string arg)
        {
            try
            {
                string _error = null;
        ...
        public async static void Copy_1(string source, string destination, bool isOverwrite, bool copyWebConfig)
        {
            try
            {
                ...
                foreach (DirectoryInfo subdir in dirs)
                {
                    ...
                    if (copyWebConfig)
                    {
                        Copy_1(subdir.FullName, Path.Combine(destination, subdirName), true, true);
                    }
                    else
                    {
                        Copy_1(subdir.FullName, Path.Combine(destination, subdirName), true, false);
                    }
                }                
            }
            catch (Exception err)
        ...
        public async static void Copy_1(string file, string fileDestinationName, bool isOverwrite)
        {
            try
            {                
        ...
        public async static Task<bool> Compress_1(string folder, string fileName)
        {
            try
            {             
